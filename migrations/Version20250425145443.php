 ...
 */
final class Version20250425145443 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE users ADD CONSTRAINT FK_1483A5E97294869C FOREIGN KEY (article_id) REFERENCES articles (id)
        SQL);
        $this->addSql(<<<'SQL'
